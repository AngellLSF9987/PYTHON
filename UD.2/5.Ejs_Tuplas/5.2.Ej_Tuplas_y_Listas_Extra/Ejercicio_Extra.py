...
if es_admin:
    ...
    print("\nMenú Administrador.\n")
    print("A. Agregar una nueva película.\n")
    print("B. Modificar el contenido de la lista de películas.\n")
    print("C. Eliminar una película de la lista.\n")
    option = input("Seleccione una de las opciones disponibles;\n ").upper()
    
    # OPCIÓN A: AGREGAR UNA PELÍCULA
    ...
    #   OPCIÓN B: MODIFICAR UNA PELÍCULA
    ...
    # OPCIÓN C: ELIMINAR UNA PELÍCULA.
    ...
    print("\nMenú Cliente:\n")
    print("A. Buscar película por título.\n")
    print("B. Buscar películas por género.\n")
    print("C. Cambiar contraseña de usuario.\n")
    print("D. Crear listas de películas favoritas que se quiere ver.\n")
    print("E. Mostrar la lista de películas favoritas.\n")
    option = input("Seleccione una de las opciones disponibles:\n ").upper()
    
    # OPCIÓN A: BUSCAR PELÍCULA POR TÍTULO
    ...
    #   OPCIÓN B: BUSCAR PELÍCULA POR GÉNERO
    ...
    # OPCIÓN C: CAMBIAR LA CONTRASEÑA.
