...
# Mostrar asignaturas a repetir en una sola línea con comas y punto al final

if asignaturas_repetir:
    print("Tienes que repetir las siguientes asignaturas:", end=" ")
    
    # Bucle con índice: Recorremos la lista asignaturas_repetir utilizando un bucle for con índices (range(len(asignaturas_repetir))).
    ...
    # Si es así, añadimos un punto (".") al final. Si no, se añade una coma con un espacio (", ").    
        ...
        if i == len(asignaturas_repetir) - 1:
            print(asignaturas_repetir[i] + ".")  # Última asignatura con punto final
            
        else:
            
    # Uso de end=" ": En las asignaturas que no son la última, usamos end=" " para que las asignaturas se impriman en la misma línea.
    
            print(asignaturas_repetir[i] + ",", end=" ")
else:
    print("¡Felicidades! No tienes asignaturas que repetir.")